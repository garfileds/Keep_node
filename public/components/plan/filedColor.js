define('public/components/plan/filedColor.vue', function(require, exports, module) {
  ...
  __vue__options__.render =function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"filed"},[_c('div',{staticClass:"filed__name"},[_vm._v("颜色")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.selectedColor.backgroundColor),expression:"selectedColor.backgroundColor"}],attrs:{"type":"hidden","name":"color"},domProps:{"value":(_vm.selectedColor.backgroundColor)},on:{"input":function($event){if($event.target.composing){ return; }_vm.selectedColor.backgroundColor=$event.target.value}}}),_vm._v(" "),_c('input',{attrs:{"type":"hidden","name":"progress_color"},domProps:{"value":_vm.progressColor}}),_vm._v(" "),_c('div',{staticClass:"filed__content",style:(_vm.selectedColor),on:{"click":function($event){_vm.togglePanel(true)}}}),_vm._v(" "),_c('section',{directives:[{name:"show",rawName:"v-show",value:(_vm.panelVisible),expression:"panelVisible"}],staticClass:"color-panel",on:{"click":_vm.selectColor}},[_c('div',{staticClass:"color-panel__return",on:{"click":function($event){_vm.togglePanel(false)}}}),_vm._v(" "),_vm._l((_vm.colors),function(color){return _c('color-panel-item',{attrs:{"color":color}})})],2)])}
